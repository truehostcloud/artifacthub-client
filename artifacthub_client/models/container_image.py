...
class ContainerImage(Package):
    ...
    @property
    def data(self):
        """Gets the data of this ContainerImage.  # noqa: E501


        :return: The data of this ContainerImage.  # noqa: E501
        :rtype: ContainerImageData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ContainerImage.


        :param data: The data of this ContainerImage.  # noqa: E501
